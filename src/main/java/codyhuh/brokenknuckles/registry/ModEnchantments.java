...
import codyhuh.brokenknuckles.common.enchantment.HoleDiggerEnchantment;
...
public class ModEnchantments {
    public static final DeferredRegister<Enchantment> ENCHANTMENTS =
            DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, BrokenKnuckles.MOD_ID);
    ...
    public static final RegistryObject<Enchantment> HOLE_DIGGER =
            ENCHANTMENTS.register("hole_digger",
                    () -> new HoleDiggerEnchantment(Enchantment.Rarity.RARE, HAMMER,
